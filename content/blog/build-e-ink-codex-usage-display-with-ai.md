...
<img src="/images/blog/codex-usage-display/final-three-quarter.webp" alt="The finished purple e-paper Codex usage display, showing the remaining weekly percentage, reset time, and last refresh" width="1600" height="1201" loading="eager" fetchpriority="high" decoding="async" srcset="/images/blog/codex-usage-display/final-three-quarter-800.webp 800w, /images/blog/codex-usage-display/final-three-quarter.webp 1600w" sizes="(max-width: 800px) 100vw, 800px">
...
<img src="/images/blog/codex-usage-display/final-in-situ-close.webp" alt="A closer view of the finished purple e-paper display beneath the monitor." width="1600" height="1164" loading="lazy" decoding="async" srcset="/images/blog/codex-usage-display/final-in-situ-close-800.webp 800w, /images/blog/codex-usage-display/final-in-situ-close.webp 1600w" sizes="(max-width: 800px) 100vw, 800px">
...
<img src="/images/blog/codex-usage-display/architecture.svg" alt="Diagram showing Codex data moving through a privacy-filtering Mac service over USB to the ESP32 e-paper display" width="1600" height="560" loading="lazy" decoding="async">
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin:1.5rem 0;">
  <img src="/images/blog/codex-usage-display/screen-portrait-directions.webp" alt="Early portrait layout directions for the e-paper usage display" width="800" height="800" loading="lazy" decoding="async" style="width:100%;height:auto;">
  <img src="/images/blog/codex-usage-display/screen-landscape-first-pass.webp" alt="First landscape layout for the e-paper usage display" width="800" height="391" loading="lazy" decoding="async" style="width:100%;height:auto;">
  <img src="/images/blog/codex-usage-display/screen-last-refresh-revision.webp" alt="Landscape layout revised to include the last refresh time" width="800" height="391" loading="lazy" decoding="async" style="width:100%;height:auto;">
  <img src="/images/blog/codex-usage-display/screen-final-layout.webp" alt="Approved display mock with remaining usage on the left and reset information on the right" width="800" height="391" loading="lazy" decoding="async" style="width:100%;height:auto;">
  <img src="/images/blog/codex-usage-display/screen-implemented-hardware-layout.svg" alt="Implemented hardware layout with reset information on the left and remaining usage on the right" width="1000" height="488" loading="lazy" decoding="async" style="width:100%;height:auto;grid-column:1/-1;">
</div>
...
<img src="/images/blog/codex-usage-display/enclosure-directions.webp" alt="Two early enclosure directions, one rounded and one slim" width="1600" height="587" loading="lazy" decoding="async" srcset="/images/blog/codex-usage-display/enclosure-directions-800.webp 800w, /images/blog/codex-usage-display/enclosure-directions.webp 1600w" sizes="(max-width: 800px) 100vw, 800px">
...
<img src="/images/blog/codex-usage-display/cad-exact-assembly.webp" alt="CAD rendering of the final frame, board, backplate, leg, and cable path" width="1600" height="1000" loading="lazy" decoding="async" srcset="/images/blog/codex-usage-display/cad-exact-assembly-800.webp 800w, /images/blog/codex-usage-display/cad-exact-assembly.webp 1600w" sizes="(max-width: 800px) 100vw, 800px">
...
<img src="/images/blog/codex-usage-display/first-print-parts.webp" alt="The four pieces from the first print laid out on the desk" width="1600" height="1201" loading="lazy" decoding="async" srcset="/images/blog/codex-usage-display/first-print-parts-800.webp 800w, /images/blog/codex-usage-display/first-print-parts.webp 1600w" sizes="(max-width: 800px) 100vw, 800px">
...
<img src="/images/blog/codex-usage-display/v2-spaghetti.webp" alt="Failed unsupported geometry from the second enclosure print" width="1600" height="1201" loading="lazy" decoding="async" srcset="/images/blog/codex-usage-display/v2-spaghetti-800.webp 800w, /images/blog/codex-usage-display/v2-spaghetti.webp 1600w" sizes="(max-width: 800px) 100vw, 800px">
...
<img src="/images/blog/codex-usage-display/device-depth.webp" alt="The real board and cable showing the rear component depth that the enclosure had to clear" width="1600" height="2131" loading="lazy" decoding="async" srcset="/images/blog/codex-usage-display/device-depth-800.webp 800w, /images/blog/codex-usage-display/device-depth.webp 1600w" sizes="(max-width: 800px) 100vw, 800px">
...
<img src="/images/blog/codex-usage-display/v3-leg-contact.webp" alt="The V3 rear leg touching the desk on one corner" width="1600" height="1201" loading="lazy" decoding="async" srcset="/images/blog/codex-usage-display/v3-leg-contact-800.webp 800w, /images/blog/codex-usage-display/v3-leg-contact.webp 1600w" sizes="(max-width: 800px) 100vw, 800px">
...
<img src="/images/blog/codex-usage-display/magnet-installation.webp" alt="Installing the tiny magnets in the V4 frame" width="1600" height="1201" loading="lazy" decoding="async" srcset="/images/blog/codex-usage-display/magnet-installation-800.webp 800w, /images/blog/codex-usage-display/magnet-installation.webp 1600w" sizes="(max-width: 800px) 100vw, 800px">
...
<img src="/images/blog/codex-usage-display/magnets-and-backplate.webp" alt="The frame and magnetic backplate with all eight magnets installed" width="1600" height="1201" loading="lazy" decoding="async" srcset="/images/blog/codex-usage-display/magnets-and-backplate-800.webp 800w, /images/blog/codex-usage-display/magnets-and-backplate.webp 1600w" sizes="(max-width: 800px) 100vw, 800px">
...
<img src="/images/blog/codex-usage-display/final-side-profile.webp" alt="The finished enclosure from the side, showing the backward lean" width="1600" height="1201" loading="lazy" decoding="async" srcset="/images/blog/codex-usage-display/final-side-profile-800.webp 800w, /images/blog/codex-usage-display/final-side-profile.webp 1600w" sizes="(max-width: 800px) 100vw, 800px">
