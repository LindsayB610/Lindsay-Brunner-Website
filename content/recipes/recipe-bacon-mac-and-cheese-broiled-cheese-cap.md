---
title: "Bacon Mac and Cheese With a Broiled Cheese Cap"
date: 2026-01-18
...
recipeIngredient:
  ...
  - "6 oz shredded melting cheese (see notes)"
...
recipeInstructions:
  - "Cook the bacon until fully rendered and crisp but not brittle. Chop what you need and reserve 1 Tbsp of the fat."
  - "Boil the pasta 1 minute shy of al dente. Reserve ½ cup pasta water, then drain."
  - "Make a blonde roux with butter, bacon fat, and flour. Whisk in milk and cream and simmer until thickened."
  - "Off the heat, melt Velveeta first, then add shredded cheeses in handfuls until smooth."
  - "Fold in pasta and bacon, loosening with pasta water if needed."
  - "Transfer to a broiler-safe dish, top with cheese, broil until browned, then portion and serve."
---
...
1. **Cook the bacon**
   ...
   You can do this in a skillet or use a hands-off method like [easy oven bacon](https://lindsaybrunner.com/recipes/2025-12-13/recipe-easy-oven-bacon/). However you cook it, make sure the bacon reaches this level of crispness before using it here.
...
3. **Make the roux**
   ...
   In a large saucepan (or the bacon skillet, wiped out if needed), melt the butter over medium heat. Add the reserved bacon fat.
...
4. **Thicken the sauce base**
   ...
   Stir in the salt, pepper, and garlic powder (if using).

5. **Melt the cheeses**

   Turn the heat to low and remove the pan from the heat.

   Add the cubed Velveeta and stir until fully melted and glossy. Add the shredded cheeses (whatever blend you're using) in small handfuls, stirring until each addition melts before adding the next.

   Taste and adjust seasoning. Bacon and cheese can swing salty.
...
7. **Broil the cheese cap**
   ...
   Transfer the mac to a broiler-safe baking dish (an 8×8-inch dish works well) and spread evenly. Top with the shredded cheese and Parmesan, if using.
...
This recipe is written with a specific cheese blend that melts smoothly and tastes balanced. You can follow it exactly, or you can use what you already have.

The only required element is **Velveeta or American-style processed cheese**, which keeps the sauce smooth and stable. Do not skip it unless you are intentionally using the no-Velveeta version below.

For the remaining cheeses:
- Use any good melting cheese (cheddar, Monterey Jack, fontina, low-moisture mozzarella, Gruyère).
- Avoid very dry or crumbly cheeses as the main component.
- Aim for roughly the same total weight of shredded cheese as written.
...
- **Elbows:** fine, but they absorb more liquid. Cook 2 minutes shy of al dente and plan on adding extra pasta water.
- **Cavatappi:** closest to a pub-style look. Cook 1 minute shy of al dente.

### No Velveeta version

If you want to skip Velveeta entirely, increase the shredded cheese and add a stabilizer:

- Replace Velveeta with 2 oz cream cheese
- Increase total shredded cheese to about 9 oz

Keep the heat low when melting cheese.

### Bacon prep

This recipe assumes the bacon is fully cooked and crisp. If the bacon is still pliable, it will soften further once folded into the sauce.

### Storage and reheat

- Store airtight for up to 3 days.
- Reheat gently on the stovetop with a splash of milk, stirring often.
- For a fresh cheese cap, transfer hot mac to a dish, add a pinch of cheese, and broil for 1 to 2 minutes.
