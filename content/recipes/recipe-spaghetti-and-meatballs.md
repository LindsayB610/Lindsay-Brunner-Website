...
recipeIngredient:
  ...
  - "½ to 1 Tsp Better Than Bouillon Roasted Beef, max for a full pot (optional, only if sauce tastes hollow after simmering)"
  - "1 Knorr Rich Beef stock pot, max (optional, only if sauce tastes hollow after simmering)"
  - "Red wine vinegar or lemon juice, 1 Tsp at the end if it tastes heavy (optional)"
  - "1.5 to 2 lb spaghetti, depending on crowd"
