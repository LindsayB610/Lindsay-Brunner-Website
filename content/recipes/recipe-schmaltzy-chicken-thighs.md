---
title: "Schmaltzy Chicken Thighs"
date: 2026-02-05
slug: "recipe-schmaltzy-chicken-thighs"
subtitle: "Or: Bone-in thighs, schmaltz, and a hot cast iron pan"
description: "Bone-in, skin-on chicken thighs seared in cast iron with schmaltz and spices, then finished in the oven. Crispy skin, no sauce required."
draft: false
social_image: "/images/social/recipe-schmaltzy-chicken-thighs-og.png"
prepTime: "PT10M"
cookTime: "PT48M"
totalTime: "PT60M"
...
recipeInstructions:
  - "Pat the thighs very dry (if frozen, thaw in cold water first, changing the water once). Season both sides with about ¾ Tsp salt total. Set skin-side up on a plate."
  - "Melt the schmaltz and stir in the garlic powder, onion powder, paprika, and black pepper. Do not add more salt. Baste the schmaltz mixture over the skin only."
  - "Heat the oven to 425°F (220°C). Heat a 10–12 inch cast iron skillet over medium heat for 2–3 minutes. The pan is ready when the chicken sizzles immediately on contact. Place the thighs skin-side down (do not crowd; use two pans if needed). Cook without moving for 10–14 minutes until the skin is golden and well rendered. This stretch is intentionally long for fat rendering, not quick browning. Leave the rendered fat in the pan for the oven finish (spoon off excess only if it is truly excessive)."
